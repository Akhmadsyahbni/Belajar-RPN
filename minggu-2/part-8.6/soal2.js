...
nilainya merupakan hasil kali angka lain yang bukan angka itu sendiri. Contoh,
 jika arr adalah [1, 2, 3, 4, 5], maka function akan mereturn [120, 60, 40, 30, 24],
...
function perkalianUnik(arr) {
    ...
    for (let i = 0; i < arr.length; i++){
        resultArray.push(totalPerkalian/arr[i]);
    }
    return resultArray;
}
// TEST CASES
